...
const link_container = document.getElementById("link-container") as HTMLDivElement;
const shareablelink_Element = document.getElementById("shareable-link") as HTMLAnchorElement;
const download_PDF = document.getElementById("download-pdf") as HTMLButtonElement
